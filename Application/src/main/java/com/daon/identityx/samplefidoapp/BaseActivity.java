...
public abstract class BaseActivity extends Activity {
    ...
    private FidoOperation currentFidoOperation;

    protected enum FidoOpCommsType {OneWay, Return}

    // The list of FIDO Clients
    private static List<ResolveInfo> uafClientList = new ArrayList<>();
    ...
    */
     ...
     * @param opCommsType comms type. {@link com.daon.identityx.samplefidoapp.BaseActivity.FidoOpCommsType#Return} indicates that the
     *                    intent will generate a result from the client.
     *                    {@link com.daon.identityx.samplefidoapp.BaseActivity.FidoOpCommsType#OneWay} indicates that the intent is
